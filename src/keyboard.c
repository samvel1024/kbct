...
const int LAYKEYMAP_MAX_KEYCODE = KEY_MAX;

const char *laykeymap_key_name(unsigned int code) {
	return (code <= maxval[EV_KEY] && names[EV_KEY] && names[EV_KEY][code]) ? names[EV_KEY][code] : "?";
}
